...
{
    public static void onSuccess(LoginResult success)
    {

    }
     public static void onFailed(PlayFabError error)
    {
    ...
    public static void Login(System.Action<LoginResult> onSuccess, System.Action<PlayFabError> onFailed)
	{
        ...
        PlayFabClientAPI.LoginWithAndroidDeviceID(
            ...
            (LoginResult result) => 
            {
               ...
               // LoadLeaderboards(onSuccessL, onFailedL);
                IsLoggedIn = true;
            },
            // Failure
            (PlayFabError error) => 
    ...
    public static void UpdateStatistic(string stat, int value)
    {
        if(!PlayfabManager.IsLoggedIn)
            PlayfabManager.Login(onSuccess, onFailed);
